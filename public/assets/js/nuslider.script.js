$(document).ready(function () {
    ...
    //value
    var nonLinearSliderValueElement = document.getElementById(
    ...
    // custom color slider
    var extra_large_filled_circle = document.getElementById(
        "extra-large-slider-circle-filled"
    );
    ...
    // custom color slider
    var large_slider_circle_filled = document.getElementById(
        "large-slider-circle-filled"
    );
    ...
    // defualt-slider
    var default_slider_circle_filled = document.getElementById(
        "default-slider-circle-filled"
    );
    ...
    // small-slider
    var small_slider_circle_filled = document.getElementById(
        "small-slider-circle-filled"
    );
    ...
    // extra-small-slider
    var extra_small_slider_circle_filled = document.getElementById(
        "extra-small-slider-circle-filled"
    );
    ...
    // extra large
    var extra_large_square_default = document.getElementById(
        "extra-large-slider-square-default"
    );
    ...
    // large
    var large_slider_square_default = document.getElementById(
        "large-slider-square-default"
    );
    ...
    // defualt-slider
    var default_slider_square_default = document.getElementById(
        "default-slider-square-default"
    );
    ...
    // small-slider
    var small_slider_square_default = document.getElementById(
        "small-slider-square-default"
    );
    ...
    // extra-small-slider
    var extra_small_slider_square_default = document.getElementById(
        "extra-small-slider-square-default"
    );
    ...
    // connect to lower
    var verticalSlider_connectlower1 = document.getElementById(
        "slider-vertical-connect-lower-1"
    );
    ...
    var verticalSlider_connectlower2 = document.getElementById(
        "slider-vertical-connect-lower-2"
    );
    ...
    var verticalSlider_connectlower3 = document.getElementById(
        "slider-vertical-connect-lower-3"
    );
    ...
    var verticalSlider_connectlower4 = document.getElementById(
        "slider-vertical-connect-lower-4"
    );
    ...
    var verticalSlider_connectlower5 = document.getElementById(
        "slider-vertical-connect-lower-5"
    );
    ...
    var verticalSlider_connectupper1 = document.getElementById(
        "slider-vertical-connect-upper-1"
    );
    ...
    var verticalSlider_connectupper2 = document.getElementById(
        "slider-vertical-connect-upper-2"
    );
    ...
    var verticalSlider_connectupper3 = document.getElementById(
        "slider-vertical-connect-upper-3"
    );
    ...
    var verticalSlider_connectupper4 = document.getElementById(
        "slider-vertical-connect-upper-4"
    );
    ...
    var verticalSlider_connectupper5 = document.getElementById(
        "slider-vertical-connect-upper-5"
    );
    ...
    // tooltips
    var verticalSlider_tooltip1 = document.getElementById(
        "slider-vertical-tooltip-1"
    );
    ...
    var verticalSlider_tooltip2 = document.getElementById(
        "slider-vertical-tooltip-2"
    );
    ...
    var verticalSlider_tooltip3 = document.getElementById(
        "slider-vertical-tooltip-3"
    );
    ...
    var verticalSlider_tooltip4 = document.getElementById(
        "slider-vertical-tooltip-4"
    );
    ...
    var verticalSlider_tooltip5 = document.getElementById(
        "slider-vertical-tooltip-5"
    );
