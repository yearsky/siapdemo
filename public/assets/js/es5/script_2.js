...
$(document).ready(function () {
    ...
    function mobileMenuClick() {
        ...
        $(".app-admin-wrap.sidebar-full .sidebar-panel").addClass(
            "sidebar-switch-open"
        );
    }
    function sidebarSwitchOverlay() {
        $(".app-admin-wrap.sidebar-full .sidebar-panel").removeClass(
            "sidebar-switch-open"
        );
    }
    ...
    $mobileMenuCollapse.on("click", function () {
        // $appAdminWrap.toggleClass('sidebar-compact-onhover');
        $(".app-admin-wrap.sidebar-full .main-content-wrap").removeClass(
            "sidebar-full-z-index"
        );
    });
    ...
    function toggleOnHover() {
        closeSidebarCompact();
        $appAdminWrap.toggleClass("sidebar-compact-onhover");
        $(".app-admin-wrap.sidebar-full .main-content-wrap").toggleClass(
            "sidebar-full-z-index"
        );
    }
