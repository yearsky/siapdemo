...
$(document).ready(function () {
    ...
    (r = new ApexCharts(document.querySelector("#basicRadar"), e)).render();
    var r;
    e = {
        chart: {
            height: 320,
    ...
    (r = new ApexCharts(
        ...
        $(".updateRadar").on("click", function () {
            !(function () {
                ...
                r.updateSeries([
                    { name: "Series 1", data: e() },
                    { name: "Series 2", data: e() },
                    { name: "Series 3", data: e() },
                ]);
            })();
        });
    new ApexCharts(document.querySelector("#radarwithPolygonFill"), {
        chart: { height: 350, type: "radar" },
