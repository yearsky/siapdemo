...
$(document).ready(function () {
    ...
    e.on("click", function () {
        a.addClass("ul-todo-sidebar open");
    }),
        s.on("click", function () {
            a.removeClass(" open");
        });
    var n = [
            { id: 1, img: "assets/images/faces/1.jpg" },
            { id: 2, img: "assets/images/faces/2.jpg" },
            { id: 3, img: "assets/images/faces/3.jpg" },
            { id: 4, img: "assets/images/faces/4.jpg" },
        ],
        t = [
            {
                id: 1,
            ...
            { id: 2, title: "Harry", img: "assets/images/faces/2.jpg" },
            { id: 3, title: "Bob", img: "assets/images/faces/3.jpg" },
            { id: 4, title: "Harry", img: "assets/images/faces/4.jpg" },
        ];
    function i(e) {
        $("#userTable").append(
    ...
    $("#todo-list-search").keyup(function () {
        ...
        (e = $(this).val()),
            $("#userTable li").each(function () {
                var a = "false";
                $(this).each(function () {
                    $(this).text().toLowerCase().indexOf(e.toLowerCase()) >=
                        0 && (a = "true"),
                        "true" == a ? $(this).show() : $(this).hide();
                });
            });
    }),
        ...
        $("form#addUser").submit(function () {
            ...
            s && o && 0 != r
                ? ($(this)
                      .serializeArray()
                      .map(function (e) {
                          (a[e.name] = e.value), (a = _extends({}, a, d[0]));
                      }),
                  console.log(a),
                  (e = a),
                  t.push(e),
