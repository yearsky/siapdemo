...
$(document).ready(function () {
    ...
    new ApexCharts(document.querySelector("#SplineArea"), {
    ...
    var t = {
        ...
        title: { text: "Datetime X-Axis", align: "left" },
        dataLabels: { enabled: !1 },
    ...
    new ApexCharts(document.querySelector("#timeline-chart"), t).render();
    new ApexCharts(document.querySelector("#negetiveArea"), {
        chart: { height: 350, type: "area", toolbar: { show: !1 } },
        dataLabels: { enabled: !1 },
        stroke: { curve: "straight" },
        series: [
        ...
        fill: { type: ["gradient", "solid"], opacity: 1 },
        tooltip: {
            x: { format: "yyyy" },
    ...
    new ApexCharts(document.querySelector("#stackedAreaChart"), a).render();
    new ApexCharts(document.querySelector("#nullAreaChart"), {
        chart: {
            height: 350,
            type: "area",
            zoom: { enabled: !1 },
