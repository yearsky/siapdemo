...
var _card_body = document.getElementById("card-body"),
    _card_footer = document.getElementById("card-footer"),
    _arrow_down = document.getElementById("arrow-down"),
...
function minimizeButton(e) {
    _card_body.classList.toggle("active"), e.preventDefault();
}
function _reloadFunction(e) {
    _card_body.reload(), e.preventDefault();
}
function removeWindow(e) {
    _card.classList.add("active"), e.preventDefault();
}
