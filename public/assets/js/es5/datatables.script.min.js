...
$(document).ready(function () {
    $("#contact_list_table").DataTable({ searching: !1 }),
        ...
        $("#deafult_ordering_table").DataTable({ order: [[3, "desc"]] }),
        ...
        $("#hidden_column_table").DataTable({
            responsive: !0,
            columnDefs: [
                { targets: [2], visible: !1, searchable: !1 },
                { targets: [3], visible: !1 },
            ],
        }),
        ...
        $("#scroll_horizontal_table").DataTable({ scrollX: !0 }),
