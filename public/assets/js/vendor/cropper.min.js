...
!(function (t, i) {
        ...
        t.trim()
            ...
            .forEach(function (a) {
                if (r.once && !gt) {
                    ...
                    (s = function () {
                        for (
                            var t = arguments.length, i = Array(t), e = 0;
                            e < t;
                            e++
                        )
                            i[e] = arguments[e];
    ...
    function Dt(t) {
        ...
        return (
            i &&
            (i[1] !== Mt.protocol || i[2] !== Mt.hostname || i[3] !== Mt.port)
        );
    }
    function Bt(t) {
                ...
                i &&
                    (h
                        ? ((o.minLeft = Math.max(0, n.left)),
                          ...
                          (o.maxLeft =
                              Math.min(a.width, n.left + n.width) - o.width),
                          (o.maxTop =
                ...
                if (!this.disabled) {
                    ...
                    t.changedTouches
                        ...
                        U.test(a) &&
                            ...
                            (this.cropping = !1),
                            a === T &&
                                ((this.cropping = !0), ht(this.dragBox, o)));
                }
            },
            cropMove: function (t) {
                var i = this.action;
            ...
            change: function (t) {
                ...
                !r && t.shiftKey && (r = d && l ? d / l : 1),
                    this.limited &&
                        ...
                        (v =
                            g +
                            Math.min(a.height, e.height, e.top + e.height)));
                var x,
                    y,
                    M,
                    C = o[Object.keys(o)[0]],
            ...
            getCroppedCanvas: function () {
                ...
                var i,
                    ...
                    P =
                        ...
                        (z = Et(
                            { aspectRatio: u, width: W, height: H },
                            "cover"
                        )),
                        ...
                        (S = Et(
                            { aspectRatio: o, width: W, height: H },
                            "cover"
                        )),
                ...
                ct <= -F || rt < ct
                    ...
                    lt <= 0 || dt <= -Z || st < dt
                        ...
                        ? ((ut = -dt),
                          (dt = 0),
                          (ft = pt = Math.min(st, Z + dt)))
                        : dt <= st &&
                          ((ut = 0), (ft = pt = Math.min(Z, st - dt)));
                var vt = [ct, dt, lt, pt];
                if (0 < gt && 0 < ft) {
                    var wt = tt / F;
