...
export default function Category() {
    ...
    const customizeDate = (orders) => {
        return `First: ${formatDate(orders.value, 'MMM dd, yyyy')}`;
    };
    const submitHandler = () =>{
        alert('success')
    }
                ...
                <div className="card o-hidden mb-4">
                    ...
                    <DataGrid
                        ...
                        <Editing
                            ...
                            allowAdding={true}
                            allowDeleting={true}>
                            <Popup title="Employee Invoice" showTitle={true} width={700} height={525} />
                            ...
                            <Item itemType="group" colCount={2} colSpan={2}>
                                ...
                                <Item dataField="CustomerStoreCity" />
