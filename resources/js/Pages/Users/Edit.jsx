...
export default function Edit({user}) {
    const {id, name, email, no_handphone, password} = user
    ...
    const submitHandler = (event) =>{
        ...
        put(route('users.update',id),data);
    }
    return (
        <div>
            ...
            <div className="col-md-12">
                <div className="card mb-4">
                    ...
                    <div className="card-title mb-3">Edit User</div>
...
Edit.layout = (page) => <App children={page} title="User Edit"/>