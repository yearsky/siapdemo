        ...
        <div className="side-content-wrap">
            <div className="sidebar-left open rtl-ps-none sidebarscroll">
                <ul className="navigation-left">
                    <li className="nav-item {{ request()->is('dashboard/*') ? 'active' : '' }}" data-item="dashboard">
                    ...
                    <li className="nav-item ">
                        <Link className="nav-item-hold" href={route('home.index')}>
                    ...
                    <li className="nav-item">
                        <Link className="nav-item-hold" href={route('category.index')}>
                    ...
                    <li className="nav-item">
                        <Link className="nav-item-hold" href={route('product.index')}>
                    ...
                    <li className="nav-item">
                        <Link className="nav-item-hold" href={route('users.index')}>
                    ...
                    <li className="nav-item">
                        <Link className="nav-item-hold" href={route('datagrid.index')}>
            ...
            <div className="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
                ...
                <ul className="childNav" data-parent="dashboard">
                    <li className="nav-item ">
                        <a className="{{ Route::currentRouteName()=='dashboard_version_1' ? 'open' : '' }}" href="#">
                            <i className="nav-icon i-Clock-3" />
                            <span className="item-name">Version 1</span>
                        </a>
                    </li>
                    <li className="nav-item">
                        <a href="#" className="{{ Route::currentRouteName()=='dashboard_version_2' ? 'open' : '' }}">
                            <i className="nav-icon i-Clock-4" />
                            <span className="item-name">Version 2</span>
                        </a>
                    </li>
                    <li className="nav-item">
                        <a className="{{ Route::currentRouteName()=='dashboard_version_3' ? 'open' : '' }}" href="#">
                            <i className="nav-icon i-Over-Time" />
                            <span className="item-name">Version 3</span>
                        </a>
                    </li>
                    <li className="nav-item">
                        <a className="{{ Route::currentRouteName()=='dashboard_version_4' ? 'open' : '' }}" href="#">
